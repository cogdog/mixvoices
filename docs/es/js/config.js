// configuration for OEG Voices Mix
...
var segment_text = [
	"Hola y bienvenidos a las voces del OEG",
	"las voces del OEG",
	"las voces del OEG",
	"las voces del OEG",
	"un podcast en donde se escuchan las voces e ideas de impulsores de educación abierta de alrededor del mundo",
	"Las voces del OEG, es una iniciativa producida por el consorcio de educación abierta global ‘Open Education Global’",
	"una organización sin fines de lucro, basada en miembros",
	"apoyando el desarrollo y uso de educación abierta globalmente",
